...
@section('title-page', 'Manage Users')
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('manage-users.create', $user->id) }}">
                                        ...
                                        <form action="{{ route('manage-users.delete', $user->id) }}" method="POST">
                                            ...
                                            @csrf
                                            <td>
                                                <button type="submit" class="btn btn-danger" onclick="return confirm('Do you want to delete this user account?')">Delete</button>
                                            </td>
                                        </form>
                                    </tr>
                                @endforeach
